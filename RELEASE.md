...
6. Trigger [GitHub Actions](https://github.com/LMKKK/fx/actions) (brew, snap, docker).
7. Create a new release on [GitHub](https://github.com/LMKKK/fx/releases/new).
8. Run [build.mjs](scripts/build.mjs) to upload binaries to the release.
   ```sh
   npx zx scripts/build.mjs
   ```
9. Bump version in [install.sh](https://github.com/LMKKK/fx.wtf/blob/master/public/install.sh) and upload it
